...
#define MAX_CDMATERIALS 32
struct buildvars_t {
	int contents;
	char surfaceProp[MAX_SURFACEPROP];
	char cdMats[MAX_CDMATERIALS][MAX_PATH]; // Maximum of 32 cdmaterials
};
...
CRC32_t GetGroupingKeyAndSetNeededBuildVars(StaticPropBuild_t build, CUtlVector<buildvars_t> *vecBuildVars, bool *retVal = NULL);
